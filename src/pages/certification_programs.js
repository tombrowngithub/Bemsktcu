            ...
            <Container className="tw-bg-[#212327] text-white poppings-font">
                ...
                <Container className='grid-con-bg'>
                    ...
                    <h4 className="text-start txt-reg-requirement-2">Registration/ID Card fee is part of the training
                        Tuition for DIPLOMA
                        PROGRAMS</h4>
                    <h4 className="text-start txt-reg-requirement-2"> Registration Fee (for Professional Certificate
                        Program! – ₦5,500</h4>
                    <h4 className="text-start txt-reg-requirement-2"> Course materials = ₦20,000 complete suite [for
                        Diploma Programs</h4>
